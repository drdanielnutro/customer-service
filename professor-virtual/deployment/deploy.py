...
import vertexai
from professor_virtual.agent import root_agent
...
STAGING_BUCKET = f"gs://{configs.CLOUD_PROJECT}-adk-professor-virtual-staging"

AGENT_WHL_FILE = "./professor_virtual-0.1.0-py3-none-any.whl"
